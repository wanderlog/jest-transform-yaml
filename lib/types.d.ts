...
export interface Transformer<OptionType = unknown> {
    ...
    getCacheKey?: (sourceText: string, sourcePath: string, options: TransformOptions<OptionType> | string) => string;
    process: (sourceText: string, sourcePath: string, options: TransformOptions<OptionType> | string) => TransformedSource;
}
